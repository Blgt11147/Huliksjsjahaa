...
URL = "https://{movierequest-bot.onrender.com}/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://{movierequest-bot.onrender.com}/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://{movierequest-bot.onrender.com}/".format(FQDN)
else:
    URL = "http://{movierequest-bot.onrender.com}/".format(FQDN)
