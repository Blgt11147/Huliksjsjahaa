...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002490907179')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002490907179')
...
LANGUAGES = ["punjabi", "", "tamil", "", "english", "", "hindi", "", "telugu", "", "kannada", "", "gujarati", "", "marathi", "", "punjabi", ""]
...
URL = "https://huliksjsjahaa.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://huliksjsjahaa.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://huliksjsjahaa.onrender.com/".format(FQDN)
else:
    URL = "http://huliksjsjahaa.onrender.com/".format(FQDN)
